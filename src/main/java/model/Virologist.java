...
public class Virologist implements Steppable {
    ...
    /**
     * Ha a virológus felvesz egy védőfelszerelést vagy rákennek egy model.agents.ProtVaccine-t, akkor meghívódik ez a függvény
     * Hozzáad a virológus ágenssel való találkozási viselkedés befolyásoló listájához egy új, a védőfelszerelésre vagy model.agents.ProtVaccine-re jellemző viselkedést.
     *
    ...
    /**
     * Ha a virológus levesz egy védőfelszerelést vagy lejár a rákent model.agents.ProtVaccine ideje, akkor meghívódik ez a függvény.
     * Kivesz a virológus ágenssel való találkozási viselkedés befolyásoló listájából egy, a védőfelszerelésre vagy model.agents.ProtVaccine-re jellemző viselkedést.
     *
     ...
     */
    public ArrayList<Absorb> getAbsorbStrats() {
        return absorbStrats;
    }
    ...
    private <T> T chooseFrom(ArrayList<T> c) {
        ...
        System.out.print("\t".repeat(depth) + "~~ Which model.absorbStrats.Absorb mechanic to use? ");
