...
import model.agents.ProtVaccine;
import model.Virologist;

/**
 * A model.agents.ProtVaccine ágenst kódoló genetikai kódot megvalósító osztály.
 * Felelős az ilyen vírusok létrehozásáért.
 */
public class ProtCode extends Code {

	/**
	 * Konstruktor, amely meghatározza a model.agents.ProtVaccine létrehozásához szükséges alapanyagokat.
	 */
	public ProtCode(){
		nCost=100;
		aCost=100;
